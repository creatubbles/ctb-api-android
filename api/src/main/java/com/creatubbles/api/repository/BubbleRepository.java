...
public interface BubbleRepository {
     ...
     */
    void getForCreation(@Nullable Integer page, @NonNull String creationId, ResponseCallback<CreatubblesResponse<List<Bubble>>> callback);

    /**
     * Method is used to obtain bubbles on a Gallery with a given {@code galleryId}.
     */
    void getForGallery(@Nullable Integer page, @NonNull String galleryId, ResponseCallback<CreatubblesResponse<List<Bubble>>> callback);

    /**
     * Method is used to obtain bubbles on a User with a given {@code userId}.
     */
    void getForUser(@Nullable Integer page, @NonNull String userId, ResponseCallback<CreatubblesResponse<List<Bubble>>> callback);
     ...
     */
    void createForCreation(@NonNull String creationId, @NonNull Bubble bubble, ResponseCallback<CreatubblesResponse<Bubble>> callback);
     ...
     */
    void createForGallery(@NonNull String galleryId, @NonNull Bubble bubble, ResponseCallback<CreatubblesResponse<Bubble>> callback);

    /**
     * Method used to create bubble on a user with a given {@code userId}.
     * To create an instance of Bubble passed as {@code bubble} use {@link com.creatubbles.api.model.bubble.Bubble.Builder} and don't set any fields.
     */
    void createForUser(@NonNull String userId, @NonNull Bubble bubble, ResponseCallback<CreatubblesResponse<Bubble>> callback);

    /**
     * Method used to update a bubble with specified {@code bubbleId}.
     * This shoul only be used to update bubbles on creations.
     */
    void update(@NonNull String bubbleId, @NonNull Bubble bubble, ResponseCallback<Void> callback);

    /**
     * Method used to delete a bubble with specified {@code bubbleId}.
     */
    void delete(@NonNull String bubbleId, ResponseCallback<Void> callback);
     ...
     */
    void getColors(ResponseCallback<CreatubblesResponse<List<BubbleColor>>> callback);
}
