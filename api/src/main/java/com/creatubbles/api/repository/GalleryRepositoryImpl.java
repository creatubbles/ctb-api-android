...
public class GalleryRepositoryImpl implements GalleryRepository {
    ...
    @Override
    public void getGalleryById(String id, ResponseCallback<CtbResponse<Gallery>> callback) {
        Call<JSONAPIDocument<Gallery>> call = galleryService.getGalleryById(id);
        call.enqueue(new JsonApiResponseMapper<>(objectMapper, callback));
    }

    @Override
    public void createGallery(Gallery gallery, ResponseCallback<CtbResponse<Gallery>>
            callback) {
    ...
    @Override
    public void getGalleriesByUser(String id, ResponseCallback<CtbResponse<List<Gallery>>> callback) {
        Call<JSONAPIDocument<List<Gallery>>> call = galleryService.getGalleriesByUser(id);
        call.enqueue(new JsonApiResponseMapper<>(objectMapper, callback));
    }

    @Override
    public void getGalleriesByCreation(String id, ResponseCallback<CtbResponse<List<Gallery>>> callback) {
