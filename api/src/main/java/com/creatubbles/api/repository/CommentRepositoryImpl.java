...
class CommentRepositoryImpl implements CommentRepository {
    ...
    @Override
    public void approve(@NonNull String commentId, @Nullable ResponseCallback<Void> callback) {
        Call<Void> call = service.approve(commentId);
        call.enqueue(new BaseResponseMapper<>(objectMapper, callback));
    }

    @Override
    public void decline(@NonNull String commentId, @Nullable ResponseCallback<Void> callback) {
