...
public class LandingUrlsRepositoryImpl implements LandingUrlsRepository {
    ...
    @Override
    public void getLandingUrls(ResponseCallback<CtbResponse<List<LandingUrl>>> callback) {
        Call<JSONAPIDocument<List<LandingUrl>>> call = landingUrlsService.getLandingUrls();
        call.enqueue(new JsonApiResponseMapper<>(objectMapper, callback));
    }

    @Override
    public void getSpecificLandingUrl(LandingUrlType type, ResponseCallback<CtbResponse<LandingUrl>> callback) {
