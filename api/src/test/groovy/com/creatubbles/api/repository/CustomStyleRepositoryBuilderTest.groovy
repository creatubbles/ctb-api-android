...
class CustomStyleRepositoryBuilderTest extends Specification {
    ...
    def "should not create repository without access token"() {
        when:
        new CustomStyleRepositoryBuilder(null)
    ...
    def "should create repository with access token"() {
        given:
        def builder = new CustomStyleRepositoryBuilder(anyToken());
