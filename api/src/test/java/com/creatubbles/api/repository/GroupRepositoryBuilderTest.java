 ...
 */
public class GroupRepositoryBuilderTest {
    private GroupRepositoryBuilder builder;
    ...
    public void shouldNotCreateRepositoryWithoutAuthToken() throws Exception {
        builder = new GroupRepositoryBuilder(null);
    ...
    public void shouldCreateRepositoryWithAuthToken() throws Exception {
        builder = new GroupRepositoryBuilder(anyAuthToken());
