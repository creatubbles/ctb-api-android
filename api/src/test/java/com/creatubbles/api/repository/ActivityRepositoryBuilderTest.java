 ...
 */
public class ActivityRepositoryBuilderTest {

    private ActivityRepositoryBuilder builder;
    ...
    public void shouldNotCreateRepositoryWithoutAuthToken() throws Exception {
        builder = new ActivityRepositoryBuilder(null);
    ...
    public void shouldCreateRepositoryWithAuthToken() throws Exception {
        builder = new ActivityRepositoryBuilder(anyAuthToken());
